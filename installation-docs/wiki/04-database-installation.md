<!--
This file is a copy of (https://www.azerothcore.org/wiki/database-installation)
-->
...
**Important:** Use the MySQL root user ONLY to run the script above, never run the core as root or administrator!
