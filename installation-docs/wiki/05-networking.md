<!--
This file is a copy of (https://www.azerothcore.org/wiki/networking)
-->
...
* Open the **acore\_auth** database and find the **realmlist** table. You need to edit the **address field** according to your needs:
...
**Note:** If you are using HeidiSQL, make sure you are in the Data tab when you edit values.
