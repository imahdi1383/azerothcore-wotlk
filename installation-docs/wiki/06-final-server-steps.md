<!--
This file is a copy of (https://www.azerothcore.org/wiki/final-server-steps)
-->
...
**Warning:** NEVER create an account directly into your database unless you are ABSOLUTELY SURE that you know what to do and how to do it!
...
**Tip:** Open your **acore\_world** database and find the **command** table. This shows a full list of GM Commands, descriptions, and security levels.  
