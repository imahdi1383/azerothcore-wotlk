...
![خطای Boost در CMake](screenshots/my-errors/cmake/04-cmake-configure-error)
...
.\authserver.exe
```
![اجرای authserver.exe](screenshots/runtime/01-install/authserver)
---
...
![ساخت حساب برای بازیکن](<screenshots/runtime/01-install/create user account>)
```text
