...
![خطای Boost در CMake](screenshots/my-errors/cmake/04-cmake-configure-error.jpg)
...
.\authserver.exe
```
![اجرای authserver.exe](screenshots/runtime/01-install/authserver.jpg)
---
...
![ساخت حساب برای بازیکن](<screenshots/runtime/01-install/create user account.jpg>)
```text
